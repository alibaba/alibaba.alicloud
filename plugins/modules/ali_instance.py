...
options:
    ...
    system_disk_category:
      ...
      choices: ['cloud_efficiency', 'cloud_ssd', 'cloud_essd', 'cloud', 'cloud_auto', 'cloud_essd_entry']
      type: str
    system_disk_size:
      description:
...
def main():
    ...
    argument_spec.update(dict(
        ...
        system_disk_category=dict(type='str', default='cloud_efficiency', choices=['cloud_efficiency', 'cloud_ssd', 'cloud_essd', 'cloud', 'cloud_auto', 'cloud_essd_entry']),
