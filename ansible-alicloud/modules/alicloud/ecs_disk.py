...
def delete_disk(module, ecs, disk_id):
    ...
    try:
        ...
        module.fail_json(msg='Unable to delete disk {0}, error: {0}'.format(disk_id, e))
...
def main():
    ...
    if status == 'present':
        ...
        if operation_flag == 'present':
            ...
            changed, result, disk_id, disk_dict = create_disk(module=module, ecs=ecs, zone_id=zone_id,
