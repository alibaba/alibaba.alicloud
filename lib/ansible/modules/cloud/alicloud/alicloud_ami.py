...
options:
  ...
  disk_mapping:
    ...
    suboptions:
      device:
        description:
          - Disk Device Name value /dev/xvda start to /dev/xvdz, /dev/xvda default system
      disk:
        description:
...
def main():
    ...
    if not current_image:
        ...
        try:
            ...
            module.exit_json(changed=changed, result=result, image=get_image_detail(current_image))
        except Exception as e:
