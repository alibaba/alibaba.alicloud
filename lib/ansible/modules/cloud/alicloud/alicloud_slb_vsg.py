...
options:
  ...
  load_balancer_id:
    description:
        - The unique ID of an Server Load Balancer instance, required when C(create vserver group).
  vserver_group_name:
    description:
  ...
  vserver_group_id:
    description:
        - Virtual server group ID. Required when C(set, add, remove, describe, list vserver group)
    aliases: [ 'group_id' ]
"""
