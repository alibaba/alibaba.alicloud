...
options:
  status:
    description:
      -  Whether or not to create, delete or query VPC and query vswitch.
  ...
  vswitches:
    description:
      - List of hash/dictionary of subnets to add in VPC
    required: false
    default: null
    aliases: [ 'subnets' ]
    suboptions:
      cidr_block:
        description:
          - The CIDR block representing the subnet. It must be equal to or belong to the VPC CIDR,
            and its mask must be between 16 and 29. E.g., 192.168.1.0/24
        required: true
        default: null
      zone_id:
        description:
          - Aliyun availability zone ID which to launch the subnet.
        required: true
        default: null
      vswitch_name:
        description:
          - The name of subnet, which is a string of 2 to 128 Chinese or English characters. It must begin with an
            uppercase/lowercase letter or a Chinese character and can contain numerals, "_", or "-".
            It cannot begin with http:// or https://.
        required: false
        default: null
      description:
        description:
          - The description of subnet, which is a string of 2 to 256 characters. It cannot begin with http:// or https://.
        required: false
        default: null
  vpc_id:
    description:
      - The ID of a VPC. It required when managing an existing VPC. Such as deleting vpc, creating subnet or route entry for the VPC.
    required: false
    default: null
  purge_vswitches:
    description:
      - List of unique ID VSwicths to delete from VPC.
    required: false
    default: null
    aliases: [ 'purge_subnets' ]
  route_entries:
    description:
      - List of hash/dictionary of route entries to add in VPC.
    required: True
    default: null
    suboptions:
      dest_cidrblock:
      ...
      next_hop_id:
        description:
          - The next hop ID of route entry.
        required: true
        default: null
  purge_routes:
    description:
    ...
    suboptions:
      ...
      next_hop_id:
        ...
        default: null
  vrouter_id:
    description: The ID of the Vpc's Router
    required: false
    default: null
  pagenumber:
    description:
